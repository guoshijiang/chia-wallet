...
from base.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict


# 这里修改 sign_coin_solutions 将签名隔离出来，返回待签名的msg列表和pk列表
def unsigned_coin_solutions(
        coin_solutions: List[CoinSolution],
        additional_data: bytes,
        max_cost: int) -> [List[bytes], List[bytes]]:
